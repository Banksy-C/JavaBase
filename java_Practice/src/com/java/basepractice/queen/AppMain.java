...
public class AppMain {
	...
	public static void main(String[] args) {
		...
		while (gameDays <= 10) {
			// System.out.println("游戏运行到第" + gameDays + "天");
			...
			strMenu += "4、朕的爱妃呢?\n";
			strMenu += "陛下请选择：";
			Object objResult = JOptionPane.showInputDialog(null, strMenu, "游戏运行到第" + gameDays + "天", 0,
			...
			case "1":// 皇帝下旨选妃\t\t(增加)
				if (nnCount == nnNameArray.length) {
					System.out.println("皇帝陛下，后宫已经人满为患，皇帝家也没有米下刚了。。添加失败");
					break;
				}
				// System.out.print("请输入新晋娘娘的名讳：");
				// String newName = input.next();
				objResult = JOptionPane.showInputDialog(null, "请选择修女", "选妃", 0, new ImageIcon("images/timg.jpg"),
						newNameArray, null);
			...
			case "2":// 翻牌宠幸\t\t(修改状态)
				...
				objResult = JOptionPane.showInputDialog(null, "陛下请选择", "翻牌", 0, new ImageIcon("images/选妃翻牌.jpg"),
						nnNameArray, null);
				if (objResult == null) {
					continue;
				}
				...
				if (level[searchIndex] + 1 == levelNames.length) {
					...
					// System.out.println("宠幸" + nnNameArray[searchIndex] +
					// ",好感度+10，升级为" + levelNames[level[searchIndex]]);
					JOptionPane.showMessageDialog(null,
							"宠幸" + nnNameArray[searchIndex] + ",好感度+10，升级为" + levelNames[level[searchIndex]], "翻牌的结果",
